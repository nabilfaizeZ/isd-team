...
def help():
    print("""
Ddos/ids-team 
PEMBUAT: ISD-TEAM / INDONESIA SECURITY DOWN
NAMA: NABIL
GITHUB: https://github.com/nabilfaizeZ

Tools ini dipakai team saja indonesia security down
...
python3 ddos-isdteam.py -t (target website) -p (portwebsite) -m (jam serangan dimulai) -s (jam serangan selesai) --message (pesan)
...
contoh1 : ddos-isdteam.py -t https://example.com -p 80 -m 12 -s 13 --message Seraaangwebsiteetargettt
contoh2 : ddos-isdteam.py -t (example.com -p 25 -m 12 -s 13
